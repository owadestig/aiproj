...
class NNAgent(nn.Module):
    def __init__(self, action_space):
        ...
        self.fc1 = nn.Linear(192, 1028)
        self.fc2 = nn.Linear(1028, 1028)
        self.fc3 = nn.Linear(1028, 1028)
        self.fc4 = nn.Linear(1028, 1028)
        self.fc5 = nn.Linear(1028, 4)

        self.ln1 = nn.LayerNorm(1028)
        self.ln2 = nn.LayerNorm(1028)
        self.ln3 = nn.LayerNorm(1028)
...
class LoadedNNAgent(nn.Module):
    def __init__(self, action_space):
        ...
        # Architecture matching saved model
